...
const Card = ({ title, desc, icon }: CardProps) => {
  return (
    <div className="w-[280px] h-[340px] bg-white dark:bg-zinc-700 rounded-lg shadow-md dark:shadow-zinc-600 p-4 flex flex-col items-center pt-12 gap-3 text-center">
      {icon === "calendar" && (
